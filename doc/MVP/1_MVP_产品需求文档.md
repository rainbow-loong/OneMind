...
*   **核心价值 (内核)**: 通过与AI进行一次高效的"内在整合"对话，将阻碍学习行动的内在冲突（如拖延、分心）转化为具体、可执行的"微行动"，帮助大一新生实现学习目标。
...
**目标角色**: 大一新生 (The Freshman Student)

| 编号 | 作为... (As a...) | 我想要... (I want to...) | 以便我能... (So that I can...) |
| :--- | :--- | :--- | :--- |
| US-01 | 一个知道应该学习，却总是刷手机的大一新生 | 看清并化解我内心的拖延和分心。 | 停止刷短视频，真正开始专注学习。 |
| US-02 | 一个想要取得好成绩，但总被“太难了”念头劝退的大一新生 | 有一个伙伴能陪我分解学习任务，并鼓励我完成每天的学习目标。 | 将“取得好成绩”这个大目标，转化为每天都能完成的小行动。 |
| US-03 | 一个刚刚坚持完成一天学习计划的大一新生 | 复盘我是如何从“玩手机”到“专注学习”的。 | 固化这次成功的经验，提升我的学习自信心。 |
...
*   **功能**: 极简注册与登录。
*   **规格**:
    *   **登录方式**: 早期版本可匿名使用，或使用手机验证码键登录，简化流程。
...
*   **User (用户)**: 采用BaaS供应商（如Supabase）的内置Auth模型，支持匿名登录和与学生常用平台（如微信、手机号）的OAuth绑定。
*   **Message (对话消息)**:
    | 字段名 | 类型 | 描述 |
    | :--- | :--- | :--- |
    | `id` | UUID | 消息唯一标识符 |
